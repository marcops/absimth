package absimth.module.memoryController.util.ecc.reed;
...
public class ReedSolomonBase {
	     ...
	     */
	    public static ReedSolomonBase create(int dataShardCount, int parityShardCount) {
	        return new ReedSolomonBase(dataShardCount, parityShardCount, new InputOutputByteTableCodingLoop());
	    }

	    /**
	     * Initializes a new encoder/decoder, with a chosen coding loop.
	     */
	    public ReedSolomonBase(int dataShardCount, int parityShardCount, CodingLoop codingLoop) {
